...
//
const BotName = 'BOT IRFNADI X GILNGRHMN'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/irfnadi_/'; // Nama Instagramlu cok
const whatsapplu = '082286425538'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/DWcsjjI6TUq9KfcvZ0qMao'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/DWcsjjI6TUq9KfcvZ0qMao'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => BOT BY IRFAN X GILANG`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => BOT BY IRFAN X GILANG`)
})
